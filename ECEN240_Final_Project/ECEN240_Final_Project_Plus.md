**ECEN 240: Final Project Description (Plus)**
...
> 1\. Print the words "Hello, XX" to the ASCII display where the "XX" is
> replaced with B or S, for Brother or Sister, and the first initial of
> the last name of your instructor.
>
> 2\. Print the equation "3+4=", and then print the result of using your
> ALU to do an actual 3+4.
>
> 3\. Print the equation "3\*3=", and then print the result of
> calculations done, using the ALU, to calculate 3\*3. This is
> implementing a multiplication in software.
>
> 4\. Print the equation "4-3=", and then print the result of doing the
> 4-3 subtract operation using just the instructions with opcodes
> 0000~2~ through 0111~2~ as defined in Table 1 (don't use the
> subtraction command). This "software subtraction" is to be done by
> placing the value of +3 in a register and then using the ALU functions
> XOR and ADD to convert the +3 to -3 (using 2's complement), which may
> then be added to the 4 to obtain the result of the subtraction, 4-3.
>
> 5\. A second time, print the equation "4-3=" and use hardware
> subtraction command to calculate the value of 4-3. Print the result of
> the calculation.
...
-   The software subtract operation is to put a +3 in a register and use
    ALU functions to create the -3 that is to be added to the value 4 to
    get the result of 4-3.
